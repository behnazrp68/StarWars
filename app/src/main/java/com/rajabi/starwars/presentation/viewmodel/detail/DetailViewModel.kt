                    ...
                    .collect { resource ->
                        when (resource) {
                            ...
                            is Resource.Success -> {
                                ...
                                _uiState.value =
                                    DetailUiState.Success(resource.data as CharacterDetailsResponse)
                            }
